...
export PATH="$PATH:$HOME/bin/18sg/"
...
ON_COMPUTER(LAPTOP)
export PATH=$HOME/bin/Sourcery_G++_Lite/bin:$PATH

export PATH=$HOME/android-sdk-linux_x86/tools:$PATH
export PATH=$HOME/android-sdk-linux_x86/platform-tools:$PATH

export PATH="$HOME/bin/Bluespec-2012.01.A/bin:$PATH"
export BLUESPECDIR="$HOME/bin/Bluespec-2012.01.A/lib"
export LM_LICENSE_FILE="$HOME/bin/Bluespec-2012.01.A/license.dat"
